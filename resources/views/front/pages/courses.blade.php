...
@section('course-name','Başlanğıc səviyyədən marketing öyrənin')
@section('content')
            ...
            <div class="row justify-content-center">
                <div class="col-12 col-md-7 course-one-left">
                    ...
                    <div class="course-one-middle-up">
                        <p>
                            Kod və marketing-in birlikdə tədris
                            olunduğu Codemarketing proqramımız bu günün və gələcəyin tələb olunan ixtisasına
                            təcrübəli kadrlar hazırlayır.
                        </p>
                        <a href="">
                            İndi başlayın
                        </a>
                    ...
                    <div class="course-one-down">
                        <ul>
                            ...
                            <li>
                                <img src="{{ asset('frontend/img/course/MoneyBack_32x32.svg') }}" alt="">
                ...
                <div class="table-for-padding">
                    ...
                    <div class="table-area col-12">
                        <div class="table-left">
                            <p>
                            Rəqəmsal marketing mütəxəssisləri müasir şirkətlərin ən vacib əməkdaşlarından hesab olunur. Şirkətlərin ənənəvi marketingdən rəqəmsal marketingə inteqrasiya olunduğu bir
                                zamanda siz də bu sahə üzrə mütəxəssis olun. 
                            </p>
            ...
            <div class="row justify-content-center">
                <div class="flexible-area">
                    ...
                    <div class="flexible-right">
                        <p>
                            Ödəniş planlarımız ehtiyaclarınız əsasında qurulub. İstər təhsil haqqınızı
                            tam ödəniş edin, istərsə də hissəli ödəniş edə bilərsiniz.
                        </p>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 payment-button-area">
                    <form action="">
                        <button class="payment-button-left payment-backGround">
                            Full-time
                        </button>
                        <button class="payment-button-right">
                            Part-time
                        </button>
                    </form>
                </div>
                            ...
                            <div class="payment-information">
                                <div class="payment-up-inf">
                                    <div class="common-left">
                                        <div class="common-up">
                                            <h6>Aylıq ödəniş</h6>
                                            <p class="cost-change"> 800 manat</p>
                                        </div>
                                ...
                                <div class="common-downs">
                                    <div class="common-down-title">
                                        <!-- <p class="for-mobile-p">
                                            Full – time və part – time proqramlarımıza əsasən aylıq ödəniş planları  ilə tanış ola bilərsiniz.
                                        </p> -->
                                        <p>
                                ...
                                <div class="payment-up-inf">
                                    <div class="common-left">
                                        <div class="common-up">
                                            ...
                                            <p class="paymet-full">4500 manat</p>
                                        </div>
                                        <div class="common-down">
                                            <p class="common-down-first">
                                            Əvvəlcədən birdəfəlik ödəniş edərək endirimdən faydalanın.​
                                            </p>
                                            <p class="common-down-second" style="width:103px">
                                                Birdəfəlik ödəniş​
                                            </p>
                                        </div>
                                    </div>
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-12 col-md-5 caruesel-content">
                            <div class="caruesel-content-up">
                                ...
                                <p>
                                    Cari vəzifəsi: Marketing menecer
                                </p>
                            </div>
                        ...
                        <div class="col-12 col-md-5 caruesel-content">
                            ...
                            <div class="caruesel-text">
                                ...
                                <p>
                                    ...
                                    arzularımdan biri idi. Hər zaman proqramlaşdırma və marketingi bir arada xəyal
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-12 col-md-5 caruesel-content">
                            <div class="caruesel-content-up">
                                ...
                                <p>
                                    İndiki iş yeri: marketing mütəxəssisi
                                </p>
                            </div>
                            ...
                            <div class="caruesel-text">
                                ...
                                <p>
                                   Tələbə olduğum müddətdə marketingə marağım yaranmışdır.İşlədiyim müddətdə dizaynerliyin mənə görə olmadığına qərar verdim və marağımın arxasınca getdim.Bu kursda həm kod həm də marketing öyrənərək tələb olunan kadrlardan biri oldum.
                                </p>
                                <div class="caruesel-img-unit-two">
                                    <img src="{{ asset('frontend/img/course/Vector (2).svg') }}" alt="" >
